...
<?php
    ...
    $idUsuario = $row_edit['id'];
        
    $Usuario = $row_edit['user'];
    ...
    $estado = $row_edit['usuario_verificado'];
...
<div class="card text-center">
    ...
    <div class="card-body">
        <img src="../../../../Imagenes/img-read/user-logo.png" width="150" height="150" style="border-radius: 20px;">
    ...
    <div class="card-footer text-muted">
        <a href="usuariosActivos.php">Ir a los Usuarios</a>
    </div>
</div>
...
if(isset($_POST['actualizar'])){
    ...
    if(!empty($_POST['password'])) {
		...
		$consulta = ModificarUsuario($conexion, $idUsuario, $usuario, $password, $nombre, $apellido1, $apellido2, $email,$estado);
        if($consulta){
		...
		$consulta = ModificarUsuario2($conexion, $idUsuario, $usuario, $nombre, $apellido1, $apellido2, $email,$estado);
        if($consulta){
            move_uploaded_file($ruta, $destino); //Movemos la imagen a la carpeta
            echo "<script>alert('Usuario modificado correctamente.')</script>"; 
            echo "<script>window.open('usuariosActivos.php','_self')</script>";
