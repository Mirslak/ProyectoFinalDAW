...
<head>
    ...
    <!-- sweetalert2 -->
    <script src="../administrador/"></script>
    <style>
        body{
...
<div class="container rounded-3" style="width: 40rem;"  >
    ...
    <form method="POST"  style="background: rgba(255,255,255,0.8);" class="p-5 mt-5">
            ...
            <div class="input-group mb-3">
                ...
                <input class="form-control bg-light" type="text" name="usuario" id="usuario" autofocus required>
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">⨳</span>
                <input class="form-control bg-light" type="password" name="password" id="password" required>
                <div class="invalid-feedback">
                Por favor, introduzca su contraseña.
                </div>
            </div>
            <button class="btn bg-success text-white ms-5" style="width:10rem;"  type="submit" name="inicio">Login</button><br><br>
            <a href="#" class="ms-4">¿Has olvidado la contraseña?</a>
        </form>
</div>
