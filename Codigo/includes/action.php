      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     $message = '<label class="text-success">Poducto eliminado</label>';  
                }  
           }  
      }  
           ...
           {  
                $order_table .= '  
                     <tr>  
                          ...
                          <td><button name="delete" class="btn btn-danger btn-xs delete" id="'.$values["product_id"].'">Eliminar</button></td>  
                     </tr>  
                ';  
                ...
                <tr>  
                     <td colspan="5" align="center">  
                          <form method="post" action="cart.php">  
                               <input type="submit" name="place_order" class="btn btn-warning" value="FACTURA" />  
                          </form>  
                     </td>  
                </tr>  
           ';  
